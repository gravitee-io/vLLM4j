...
class CompletionOutputTest {
    ...
    void record_shouldHaveExpectedFields() {
        var output = new CompletionOutput(0, "Paris", List.of(42, 99), FinishReason.STOP);
    ...
    void fullConstructor_shouldPopulateLogprobs() {
        ...
        var output = new CompletionOutput(0, "hello", List.of(42), FinishReason.STOP, logprobs);
    ...
    void logprobs_multiplePositions() {
        ...
        var output = new CompletionOutput(0, "AB", List.of(10, 20), FinishReason.STOP, logprobs);
